...
public class CleanerBDIAgentC2
{
     ...
     */
    @Goal(orsuccess=false, excludemode=ExcludeMode.WhenFailed, randomselection=false)
    ...
    private void    MoveAround()
    {
    	...
    	System.out.println("Starting MoveAround()");
    	QueryChargingStation    querygoal    = new QueryChargingStation();
    	IChargingstation    chargingstation    = querygoal.station;
    	while(!querygoal.isStationKnown()) {
    		System.out.println("Wait, I won't panic, I'll move over there to try to find a station");
